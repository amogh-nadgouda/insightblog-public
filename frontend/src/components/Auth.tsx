...
import {SignupInput} from "@amogh.nadgouda/medium-common/src"
  ...
  return <div className="h-screen flex justify-center flex-col">
    <div className="flex justify-center">
      <div>
        ...
        <div className="pt-4">
        {type==="signup"?<LabelledInput label="name" placeholder="Amogh Nadgouda ..." onChange={(e)=>{
            setPostInputs({
               ...postInputs,
              name: e.target.value
            })
        }}/>:<div></div>}
        <LabelledInput label="email" placeholder="amogh.nadgouda@gmail.com" onChange={(e)=>{
          setPostInputs({
            ...postInputs,
